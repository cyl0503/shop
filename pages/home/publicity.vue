	...
	<view>
		<view class="cu-card article no-card margin-top-sm"  >
			<view class="cu-item shadow">
				<view @click="navTo('/pages/home/publicList')" hover-class='none'>
					<view class="title">
				...
				<!-- '/pages/home/noticedetail?id='+noticeId -->
				<view @click="navTo('/pages/home/publicdetail?id=-1')" hover-class='none'>
